# Week 1 - Accumulation A
## Day 1 - Push: Chest, Side Delts, Triceps
a_push_inc_db: Incline Bench Press, Dumbbell / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_wide_smith: Bench Press Wide Grip, Smith Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 135lb / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_cable_fly: Chest Fly, Cable / ...vmrHypertrophy / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 12.5lb / progress: custom(increment: 2.5lb, lastWeight: 13.5lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_push_dip_machine: Triceps Dip, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 137lb / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_triceps_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 45lb / progress: custom(lastWeight: 40lb, mesoWeek: 2, targetRpe: 8.25) { ...vmrHypertrophy }
a_push_kickback_cable: Triceps Kickback, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 24.5lb / progress: custom(increment: 2.5lb, targetRpe: 8) { ...vmrHypertrophy }

## Day 2 - Pull: Back, Rear Delts, Biceps, Forearms
a_pull_standing_row: Standing Row, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_seated_row: Seated Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_straight_arm: Lat Pulldown, Cable Straight Arm / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 93lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_reverse_fly: Reverse Fly, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 71lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_preacher_machine: Preacher Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 93lb / progress: custom(targetRpe: 8, increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }
a_pull_preacher: Preacher Curl / ...vmrHypertrophy / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_pull_single_cable: Curl Single Arm, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 35.5lb / progress: custom(increment: 2.5lb, targetRpe: 8, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, numSets: 3, setsModifier: 0) { ...vmrHypertrophy }

## Day 3 - Legs
a_legs_belt_squat: Belt Squat / ...vmrHypertrophy / 1+x12-13, 2+x15-16 / 150lb / progress: custom(lastWeight: 150lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_legs_hip_press: Hip Press, Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 280lb / progress: custom(increment: 10lb, lastWeight: 270lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_legs_seated_curl: Seated Leg Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb / progress: custom(lastWeight: 90lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
a_legs_extension: Leg Extension / ...vmrHypertrophy / 1+x12-13, 2+x13-14 / 90lb / progress: custom(lastWeight: 90lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_legs_adductor: Hip Adductor / ...vmrHypertrophy
a_legs_calf_press: Calf Press on Seated Leg Press / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 110lb / progress: custom(lastWeight: 105lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }

## Day 4 - Upper: Chest, Back, Arms
a_upper_hammer_bench: Bench Press, Hammer Strength Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb / progress: custom(lastWeight: 140lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
a_upper_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 120lb / progress: custom(lastWeight: 115lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_upper_high_row: High Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb / progress: custom(lastWeight: 90lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
a_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(lastWeight: 110lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
Standing Row Rear Delt With Rope / ...vmrHypertrophy
a_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb / progress: custom(lastWeight: 20lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
a_upper_bicep_machine: Bicep Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb / progress: custom(lastWeight: 35lb, mesoWeek: 2, targetRpe: 8.25) { ...vmrHypertrophy }
a_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 35lb / progress: custom(lastWeight: 30lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }
a_upper_tri_cable: Triceps Overhead Extension, Cable / ...vmrHypertrophy
///

vmrHypertrophy[1-6] / used: none / 3+x12-15 / 5lb @8 / warmup: none / update: custom() {~
  ...
  if (setIndex == 0) {
    ...
    /// Only do set progression during accumulation weeks
      ...
      if (state.setsModifier > 0) {
        ...
        var.rpe = var.rpe <= var.RPE_END ? var.rpe : var.RPE_END
        var.amrap = 1
        ...
        sets(state.numSets+1, numberOfSets, var.MIN_HYP_REPS, var.MIN_HYP_REPS, 1, originalWeights[state.numSets], 0, var.rpe, 0) 
      }
      ...
      for (var.set in reps) {
        if (var.set <= state.numSets) {
          sets(var.set, var.set, minReps[var.set], reps[var.set], var.amrap, originalWeights[var.set], 0, var.rpe, 0)
        }
      }
    }
    /// Deload week
      ...
      for (var.set in weights) {
        var.reps = floor(reps[var.set] * state.deloadRepsRatio) 
    ...
    /// when we miss reps and mess up progression with a potential one-off bad set/day)
      ...
      var.autoDownSetRepCutoff = state.autoDownSetMode == var.AUTO_DOWN_SET_MODE_HYP ? var.MIN_HYP_REPS : state.targetMinReps
      ...
      else if (weights[setIndex+1] < completedWeights[setIndex] && completedReps[setIndex] > var.autoDownSetRepCutoff+1) {
...
~} / progress: custom(increment: 5lb, progressType: 2, targetMinReps: 12, targetMaxReps: 15, startNumSets: 3, type: 1, autoDownSetMode: 2, deloadWeightRatio: 0.65, deloadRepsRatio: 1, deloadSetsRatio: 1, rating: 0, rateGroup: 0, numRatingExercises: 0, ratingIndex: 0, lastWeight: 0lb, numSets: 3, setsModifier: 0, mesoWeek: 1, targetRpe: 7) {~
///***PARAMETERS***///
  ...
  /// autoDownSetMode: automatically reduce weight on remaining sets (based on var.AUTO_DOWN_SET_PERCENTAGE) when last completed set is at or below certain reps: 0 => disabled, 1 => hypertrophy rep range (MIN_HYP_REPS), 2 => target rep range minimum (state.targetMinReps)
...
///***CONSTANTS***///
  ...
  var.FIXED_WEIGHT_INCR_MIN = 0.25
  /// Default increment used when starting weight is 0 and using percentage increments to ensure progression happens
  var.DEFAULT_NONZERO_INCREMENT = 1lb
...
///***Now we do progression and setup future workouts/meso***///
  ...
  if (week < var.DELOAD_WEEK) {    
    ...
    /// compared to last time and/or if we're doing a recovery session
    state.targetRpe = state.setsModifier <= 0 || var.recoveryDay ? state.targetRpe : state.targetRpe - var.RPE_INCR
    /// Since targetRpe can go past 10 (to allow repeating failure weeks while adding sets and not having RPE go back to 9)
    /// we constrain it to be within the desired range for use in calculations
    var.realRpe = state.targetRpe <= var.RPE_END ? state.targetRpe : var.RPE_END
    ...
    /// == 0 => weight was inappropriate, but user manually corrected by last set today
    ...
    if (!var.recoveryDay) {
      ...
      for (var.set in completedReps) {
        /// Check if weight rounded up to next available increment today or if user did different weight than programmed
        /// and use that for progression, otherwise use the raw original program value
        var.weight = completedWeights[var.set] > originalWeights[var.set] || completedWeights[var.set] != weights[var.set]
          ? completedWeights[var.set] : originalWeights[var.set]
          ...
          if (var.progressDay) {            
            ...
            /// Otherwise, if we hit the target reps calculate the next increment weight value
              ...
              if (state.progressType == var.PROG_TYPE_WEIGHT) {
                ...
                if (var.reps > state.targetMaxReps || (RPE[var.set] > 0 && RPE[var.set] <= var.realRpe-1.5)) {
                  ...
                  if (completedWeights[numberOfSets] > completedWeights[var.set]) {
                    ...
                    if (completedReps[numberOfSets] > state.targetMaxReps) {
                      var.incrementModifier = (completedReps[numberOfSets] - state.targetMaxReps) + 1
                    }
                    /// Otherwise, if last set with heavier weight was still notably above min reps
                    /// we can increase the weight based on how far we are from bottom of rep range
                    else if (completedReps[numberOfSets] >= state.targetMinReps+3) {
                      /// Subtract 1 so we aren't incrementing so much it brings reps to the bottom of range
                  ...
                  /// reps done in set 1
                    ...
                    var.diff = var.reps > state.targetMaxReps ?
                      var.reps - state.targetMaxReps : var.realRpe - RPE[var.set]
                ...
                if (var.reps > var.MIN_HYP_REPS) {
                  var.singleIncrWeight = completedWeights[1] /// Store what a single increment from todays completed weight would be
                  /// Fixed weight increments
                  if (state.increment >= var.FIXED_WEIGHT_INCR_MIN) {
                    var.weight += state.increment*var.incrementModifier
                    var.singleIncrWeight += state.increment
                  }
                  /// Percentage based increments
                  else {
                    var.weight += var.weight*state.increment*var.incrementModifier
                    /// Ensure some progression occurs when initial weight is 0
                    if (var.weight == 0 && state.increment > 0 && var.incrementModifier > 0) {
                      var.weight = var.DEFAULT_NONZERO_INCREMENT
                    }
                    
                    var.singleIncrWeight += var.singleIncrWeight*state.increment
                    if (var.singleIncrWeight == 0 && state.increment > 0) {
                      var.singleIncrWeight = var.DEFAULT_NONZERO_INCREMENT
                    }
                  }
                  var.firstSetProgType = var.PROG_TYPE_WEIGHT

                  var.nextWeightRounded = roundWeight(var.weight)
                  /// Check if we incremented to a weight that is unavailable due to equipment/rounding restrictions
                  /// and will instead be rounded to the same weight as today for next week, in that case ensure
                  /// we add a rep since we hit targets today so we keep progressing
                  if (var.nextWeightRounded <= completedWeights[var.set]) {
                    var.reps += 1
                    var.minReps = var.reps
                    var.incrementModifier = 1
                    var.firstSetProgType = var.PROG_TYPE_REPS
                  }
                  /// If next incremented weight is available then use the rounded value for next sessions target weight
                  else {
                    /// Check if the next weight is more than 1 increment away from today's working weights and if so mark
                    /// the increment modifier so that the rep range is used next time rather than single rep target
                    if (roundWeight(var.singleIncrWeight) < var.nextWeightRounded) {
                      var.incrementModifier = 2
                    }
                    var.weight = var.nextWeightRounded
                  }
                }
              ...
              /// Double progression
              else if (var.reps >= state.targetMaxReps && var.reps >= reps[var.set]) {
                ...
                if (var.nextWeightRounded <= completedWeights[var.set]) {
                  ...
                  var.weight = var.nextWeightRounded /// Save rounded value as next week target
                  var.firstSetProgType = var.PROG_TYPE_WEIGHT
                }
              }
              else {
          ...
          if (var.progressDay) {
            if (var.hitReps) {
              ...
              if (var.firstSetProgType == var.PROG_TYPE_WEIGHT) {
                ...
                /// Ensure the weight increments when the first set does if the cofigured increment state variable
                /// is not large enough to actually reach the next available weight increment based on
                /// equipment/rounding settings
                if (roundWeight(var.weight) <= increment(completedWeights[var.set])) {
                  var.weight = increment(completedWeights[var.set])
                }
                ...
                var.reps += 1
                /// If we are progressing by reps this session but exercise progress type is set to weight that means next increment wasn't available
                /// or we were at the bottom of the rep range so we should keep minReps the same as reps when using weight/linear progression
                if (state.progressType == var.PROG_TYPE_WEIGHT) {
                  var.minReps = var.reps
                }
              }
        ...
        if (week == 1 || var.hitReps) {
          ...
          minReps[var.DELOAD_WEEK:*:*:var.set] = 0
    ...
    if (var.progressDay == 1 && var.hitReps == 1) {      
      ...
      var.todayRir = 10 - ceil(RPE[1] > 0 ? RPE[1] : var.realRpe)
    ...
    /// Set RPE target for next session. Don't increment RPE if progression is disabled
    /// and ensure it's always >= the mesocycle starting value and <= to the max allowed
...
# Week 2 - Accumulation B
## Day 1 - Push: Chest, Side Delts, Triceps
b_push_db_bench: Bench Press, Dumbbell / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb / progress: custom(lastWeight: 55lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_push_inc_smith: Incline Bench Press, Smith Machine / ...vmrHypertrophy
b_push_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 131.25lb / progress: custom(lastWeight: 126.5lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_push_cable_fly: Chest Fly, Cable / ...vmrHypertrophy
b_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x15-16 / 11lb / progress: custom(increment: 2.5lb, lastWeight: 11lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_push_crossover: Triceps Crossover, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb / progress: custom(lastWeight: 33lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_push_cable_extension: Triceps Extension, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 80lb / progress: custom(lastWeight: 77lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_push_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 90lb / progress: custom(lastWeight: 88lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }

## Day 2 - Pull: Back, Rear Delts, Biceps, Forearms
b_pull_high_row: High Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(lastWeight: 110lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_pull_seated_row: Seated Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(lastWeight: 110lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_pull_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 130lb / progress: custom(lastWeight: 126lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_pull_lat_pullover: Lat Pullover, Leverage Machine / ...vmrHypertrophy
b_pull_reverse_fly: Reverse Fly, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 70lb / progress: custom(lastWeight: 66lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_pull_preacher_machine: Preacher Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 92.5lb / progress: custom(lastWeight: 88lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_pull_preacher: Preacher Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb / progress: custom(lastWeight: 20lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_pull_single_cable: Curl Single Arm, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 45lb / progress: custom(increment: 2.5lb, lastWeight: 44lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }

## Day 3 - Legs
b_legs_hip_press: Hip Press, Machine / ...vmrHypertrophy / progress: custom(increment: 10lb) { ...vmrHypertrophy }
b_legs_belt_squat: Belt Squat / ...vmrHypertrophy
b_legs_seated_curl: Seated Leg Curl / ...vmrHypertrophy
b_legs_extension: Leg Extension / ...vmrHypertrophy
b_legs_adductor: Hip Adductor / ...vmrHypertrophy
b_legs_calf_press: Calf Press on Seated Leg Press / ...vmrHypertrophy

## Day 4 - Upper: Chest, Back, Arms
b_upper_db_bench: Bench Press, Dumbbell / ...vmrHypertrophy
b_upper_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb / progress: custom(lastWeight: 140lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_upper_standing_row: Standing Row, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb / progress: custom(lastWeight: 90lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb / progress: custom(lastWeight: 110lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_upper_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x15-16 / 11lb / progress: custom(increment: 2.5lb, lastWeight: 11lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }
b_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb / progress: custom(lastWeight: 20lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
Curl Single Arm, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb / progress: custom(lastWeight: 55lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy
b_upper_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 80lb / progress: custom(lastWeight: 77lb, mesoWeek: 3, targetRpe: 8.25) { ...vmrHypertrophy }


# Week 3 - Accumulation A
## Day 1 - Push: Chest, Side Delts, Triceps
a_push_inc_db: Incline Bench Press, Dumbbell / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb
a_push_wide_smith: Bench Press Wide Grip, Smith Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 135lb
a_push_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb
a_push_cable_fly: Chest Fly, Cable / ...vmrHypertrophy
a_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 15lb
a_push_dip_machine: Triceps Dip, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 141.25lb
a_push_jm_smith-zre: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 85lb / progress: custom(targetRpe: 8) { ...vmrHypertrophy }
a_push_kickback_cable: Triceps Kickback, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb

## Day 2 - Pull: Back, Rear Delts, Biceps, Forearms
a_pull_standing_row: Standing Row, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_pull_seated_row: Seated Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_pull_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_pull_straight_arm: Lat Pulldown, Cable Straight Arm / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb
a_pull_reverse_fly: Reverse Fly, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 75lb
a_pull_preacher_machine: Preacher Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 92.5lb
a_pull_preacher: Preacher Curl / ...vmrHypertrophy
a_pull_single_cable: Curl Single Arm, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 35lb

## Day 3 - Legs
a_legs_belt_squat: Belt Squat / ...vmrHypertrophy / 1+x12-13, 2+x15-16 / 150lb
a_legs_hip_press: Hip Press, Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 280lb
a_legs_rdl: Romanian Deadlift / ...vmrHypertrophy
a_legs_seated_curl: Seated Leg Curl / ...vmrHypertrophy / 1+x12-15 95lb, 2+x8-15 105lb
a_legs_extension: Leg Extension / ...vmrHypertrophy / 1+x12-13, 2+x13-14 / 90lb
a_legs_adductor: Hip Adductor / ...vmrHypertrophy
a_legs_calf_press: Calf Press on Seated Leg Press / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_legs_cable_crunch: Cable Crunch / ...vmrHypertrophy

## Day 4 - Upper: Chest, Back, Arms
a_upper_hammer_bench: Bench Press, Hammer Strength Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb
a_upper_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 120lb
a_upper_high_row: High Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb
a_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_upper_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 15lb / progress: custom(lastWeight: 10lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
a_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 1+x12-15 25lb, 1+x8-15 25lb, 1+x8-15 15lb
a_upper_bicep_machine: Bicep Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb
a_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 35lb
a_upper_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 85lb / progress: custom(lastWeight: 80lb, mesoWeek: 3, targetRpe: 8.5) { ...vmrHypertrophy }


# Week 4 - Accumulation B
## Day 1 - Push: Chest, Side Delts, Triceps
b_push_db_bench: Bench Press, Dumbbell / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb
b_push_inc_smith: Incline Bench Press, Smith Machine / ...vmrHypertrophy
b_push_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 131.25lb
b_push_cable_fly: Chest Fly, Cable / ...vmrHypertrophy
b_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x15-16 / 11lb
b_push_crossover: Triceps Crossover, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb
b_push_cable_extension: Triceps Extension, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 80lb
b_push_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 90lb

## Day 2 - Pull: Back, Rear Delts, Biceps, Forearms
b_pull_high_row: High Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
b_pull_seated_row: Seated Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
b_pull_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 130lb
b_pull_straight_arm: Lat Pullover, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 105lb / progress: custom(lastWeight: 100lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_pull_reverse_fly: Reverse Fly, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 70lb
b_pull_preacher_machine: Preacher Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 92.5lb
b_pull_preacher: Preacher Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb
b_pull_single_cable: Curl Single Arm, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 45lb

## Day 3 - Legs
b_legs_hip_press: Hip Press, Machine / ...vmrHypertrophy
b_legs_belt_squat: Belt Squat / ...vmrHypertrophy
b_legs_rdl: Romanian Deadlift / ...vmrHypertrophy
b_legs_seated_curl: Seated Leg Curl / ...vmrHypertrophy
b_legs_extension: Leg Extension / ...vmrHypertrophy
b_legs_adductor: Hip Adductor / ...vmrHypertrophy
b_legs_calf_press: Calf Press on Seated Leg Press / ...vmrHypertrophy
b_legs_cable_crunch: Cable Crunch / ...vmrHypertrophy

## Day 4 - Upper: Chest, Back, Arms
b_upper_db_bench: Bench Press, Dumbbell / ...vmrHypertrophy
b_upper_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb
b_upper_standing_row: Standing Row, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb
b_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
b_upper_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x15-16 / 11lb
b_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb
b_upper_bicep_machine: Bicep Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb / progress: custom(lastWeight: 35lb, mesoWeek: 2, targetRpe: 8) { ...vmrHypertrophy }
b_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy
b_upper_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 80lb


# Week 5 - Peak Accumulation A
## Day 1 - Push: Chest, Side Delts, Triceps
a_push_inc_db: Incline Bench Press, Dumbbell / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 60lb
a_push_wide_smith: Bench Press Wide Grip, Smith Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 135lb
a_push_pec_deck: Pec Deck / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 145lb
...
a_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 15lb
a_push_dip_machine: Triceps Dip, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 141.25lb
a_push_jm_smith-zre: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 85lb
a_push_kickback_cable: Triceps Kickback, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 25lb
...
a_upper_high_row: High Row / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 95lb
a_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 115lb
a_upper_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 15lb
a_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 1+x12-15 25lb, 1+x8-15 25lb, 1+x8-15 15lb
a_upper_bicep_machine: Bicep Curl, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 40lb
a_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 35lb
a_upper_pushdown: Triceps Pushdown / ...vmrHypertrophy / 1+x12-15, 2+x8-15 / 85lb


# Week 6 - Deload A
## Day 1 - Push: Chest, Side Delts, Triceps
a_push_inc_db: Incline Bench Press, Dumbbell / ...vmrHypertrophy / 1+x0-15, 1+x0-10, 1+x0-16 / 35lb @6
a_push_wide_smith: Bench Press Wide Grip, Smith Machine / ...vmrHypertrophy / 1+x0-15, 1+x0-12, 1+x0-15 / 82.5lb @6
a_push_pec_deck: Pec Deck / ...vmrHypertrophy / 3+x0-15 / 90lb @6
a_push_cable_fly: Chest Fly, Cable / ...vmrHypertrophy / @6
a_push_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x0-16 / @6
a_push_dip_machine: Triceps Dip, Leverage Machine / ...vmrHypertrophy / 1+x0-20 85lb, 2+x0-15 95lb / @6
a_push_jm_smith-zre: Triceps Pushdown / ...vmrHypertrophy / 2+x0-15, 1+x0-18 / 50lb @6
a_push_kickback_cable: Triceps Kickback, Cable / ...vmrHypertrophy / 2+x0-15, 1+x0-12 / 15lb @6

## Day 2 - Pull: Back, Rear Delts, Biceps, Forearms
a_pull_standing_row: Standing Row, Leverage Machine / ...vmrHypertrophy / 2+x0-15, 1+x0-18 / 71.25lb @6
a_pull_seated_row: Seated Row / ...vmrHypertrophy / 3+x0-15 / 70lb @6
a_pull_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 2+x0-15, 1+x0-18 / 70lb @6
a_pull_straight_arm: Lat Pulldown, Cable Straight Arm / ...vmrHypertrophy / 3+x0-15 / 55lb @6
a_pull_reverse_fly: Reverse Fly, Leverage Machine / ...vmrHypertrophy / 3+x0-18 / 42.5lb @6
a_pull_preacher_machine: Preacher Curl, Leverage Machine / ...vmrHypertrophy / 1+x0-15, 1+x0-18, 1+x0-20 / 56.25lb @6
a_pull_preacher: Preacher Curl / ...vmrHypertrophy / @6
a_pull_single_cable: Curl Single Arm, Cable / ...vmrHypertrophy / 3+x0-15 / 20lb @6

## Day 3 - Legs
a_legs_belt_squat: Belt Squat / ...vmrHypertrophy / 1+x0-12, 2+x0-15 / 100lb @6
a_legs_hip_press: Hip Press, Machine / ...vmrHypertrophy / 2+x0-15, 1+x0-16 / 175lb @6
a_legs_rdl: Romanian Deadlift / ...vmrHypertrophy
a_legs_seated_curl: Seated Leg Curl / ...vmrHypertrophy / 1+x0-15 57.5lb, 2+x0-15 65lb / @6
a_legs_extension: Leg Extension / ...vmrHypertrophy / 1+x0-12, 2+x0-13 / 57.5lb @6
a_legs_adductor: Hip Adductor / ...vmrHypertrophy
a_legs_calf_press: Calf Press on Seated Leg Press / ...vmrHypertrophy / 3+x0-20 / 67.5lb @6
a_legs_cable_crunch: Cable Crunch / ...vmrHypertrophy

## Day 4 - Upper: Chest, Back, Arms
a_upper_hammer_bench: Bench Press, Hammer Strength Machine / ...vmrHypertrophy / 2+x0-15, 1+x0-12 / 90lb @6
a_upper_pec_deck: Pec Deck / ...vmrHypertrophy / 3+x0-15 / 73.75lb @6
a_upper_high_row: High Row / ...vmrHypertrophy / 3+x0-15 / 57.5lb @6
a_upper_lat_pulldown: Lat Pulldown / ...vmrHypertrophy / 3+x0-15 / 70lb @6
a_upper_lateral_cable: Lateral Raise, Cable / ...vmrHypertrophy / 3+x0-15 / @6
a_upper_incline_curl: Incline Curl / ...vmrHypertrophy / 2+x0-15 12.5lb, 1+x0-15 10lb / @6
a_upper_bicep_machine: Bicep Curl, Leverage Machine / ...vmrHypertrophy / 3+x0-15 / 22.5lb @6
a_upper_tri_machine: Triceps Extension, Leverage Machine / ...vmrHypertrophy / 3+x0-15 / 18.75lb @6
a_upper_pushdown: Triceps Pushdown / ...vmrHypertrophy / 3+x0-15 / 50lb @6
